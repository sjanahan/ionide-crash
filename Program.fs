...
let main argv =
    let p = "Ugh"
    let s =  sprintf """Hello World from F#! %s """ p
    let slugJsString = """
(function (root) {
    ...
    let groddRskus = """{
        "beast_rsku_descriptive": {
            ...
            "bullets": { "#preserve": true},
            "terms": { "#preserve": true}
        },
        "beast_rsku_product": {
            "product_data_identifier_upc":    { "#preserve": true, "#pivots": [{"use_index": true}] },
            "product_data_identifier_isbn10": { "#preserve": true, "#pivots": [{"use_index": true}] },
            "product_data_identifier_isbn13": { "#preserve": true, "#pivots": [{"use_index": true}] },
            "product_data_identifier_ean":    { "#preserve": true, "#pivots": [{"use_index": true}] },
            "product_data_identifier_gtin14": { "#preserve": true, "#pivots": [{"use_index": true}] },
            "mart_ids" : {"#preserve": true, "#pivots": [{"use_index": true}] },
            "shipping_data" : {"#preserve": true, "#pivots": [{"use_index": true}] }
        }
    } """
